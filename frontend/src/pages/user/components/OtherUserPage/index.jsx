...
export const OtherUserPage = () => {
    ...
    const isMyFriend = useMemo(() => friends.filter((friend) => friend.username === username)?.length === 1, [friends, username])
        ...
        <>
            ...
            {otherUser &&
                <>
                    <SC.Container>
                        <SC.AvatarWrapper>
                            <Avatar avatar={otherUser.avatar ? process.env.REACT_APP_API_URL+otherUser.avatar : no_image} />
                            {!isAdmin &&
                                <FriendshipManage
