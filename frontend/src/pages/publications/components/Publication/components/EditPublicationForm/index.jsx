...
export const EditPublicationForm = ({ post, onOpenModal, closeEditForm }) => {
    const {register, handleSubmit, formState: { errors, dirtyFields}} = useForm({ mode: "onChange", defaultValues: { title: post.title, body: post.body, friendsOnly: post.friendsOnly } })
